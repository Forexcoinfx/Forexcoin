...
{
    int64_t nSubsidy = 500.0 * COIN;
	
	if(pindexBest->nHeight == 2)
	{
		int64_t nSubsidy = 700000000 * COIN;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // ForexCoin: check proof-of-stake block signature
...
// ForexCoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "1476412553 ";
        CTransaction txNew;
        txNew.nTime = 1476412553;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x910c6aa933cc5dc3277ba598a07d6e37ad983692c26332d7fc8ff5c0c28389e0"));
        block.print();
